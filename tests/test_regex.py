...
def test_get_min_dfa() -> None:
    ...
    expected_dfa.add_final_state(state_3)
    ...
    expected_dfa.add_transition(state_0, symbol_x, state_3)

    expected_dfa.add_transition(state_1, symbol_l, state_1)
    expected_dfa.add_transition(state_1, symbol_e, state_2)
    expected_dfa.add_transition(state_1, symbol_x, state_3)

    expected_dfa.add_transition(state_2, symbol_e, state_2)
    expected_dfa.add_transition(state_2, symbol_x, state_3)

    expected_dfa.add_transition(state_3, symbol_x, state_3)
